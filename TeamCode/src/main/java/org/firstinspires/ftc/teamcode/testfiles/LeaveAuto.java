...
@Autonomous(name = "Roadrunner Leave Auto")
public class LeaveAuto extends OpMode {
    ...
    TrajectoryActionBuilder feckingnyeomb;
    @Override
    public void init() {
        drive = new MecanumDrive(hardwareMap, initialPos);
        feckingnyeomb = drive.actionBuilder(new Pose2d(0,0,Math.toRadians(0)))
